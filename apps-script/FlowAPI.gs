...
var _SECURED = {
  /* A277 — the lead-gen rows are one person's performance record and every count is an event the
     ...
     the browser filled in. logSalesCall and deleteSalesCall come along: a call with a Kind is one
     of the two call quotas. The reads stay open. */
  saveLeadgenRecord: 1, deleteLeadgenRecord: 1, logSalesCall: 1, deleteSalesCall: 1,
