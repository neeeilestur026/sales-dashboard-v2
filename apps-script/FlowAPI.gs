...
var SCHEMA = {
  ...
  LgLeads:      ['Lead No', 'Plant No', 'Contact No', 'Territory', 'Handed To', 'Right Person',
                 ...
                 'Next Step', 'Next Step Date', 'Presentation Date', 'Status', 'Client Created',
